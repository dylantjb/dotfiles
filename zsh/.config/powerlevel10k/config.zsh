# Generated by Powerlevel10k configuration wizard on 2021-04-02 at 21:41 BST.
...
() {
  ...
  # For example, if set to '~', the Git repository at $HOME/.git will be ignored.  Multiple patterns can be combined with '|': '~(|/foo)|/bar/baz/*'.
