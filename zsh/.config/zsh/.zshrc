...
alias update-grub="sudo grub-mkconfig -o /boot/efi/EFI/arch/grub/grub.cfg && cp /boot/efi/EFI/arch/grub/grub.cfg /boot/grub/grub.cfg"
...
alias arch='ssh -XC -c aes128-gcm@openssh.com,aes256-gcm@openssh.com,chacha20-poly1305@openssh.com,aes256-ctr,aes192-ctr,aes128-ctr dylan@192.168.1.1'
test pacman && {
  alias y='yay -Sy'
  alias yr='yay -Rns'
...
command -v instant-zsh-post >/dev/null && instant-zsh-post
#: }}}
